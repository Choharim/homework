...
<Picture src="dynamic-programing_1.png" alt="재귀 트리" />
...
메모이제이션을 통해 재귀 함수의 호출을 나타낸 트리이다. 함수 호출 횟수가 대폭 감소했다는 것을 알 수 있다. 시간 복잡도가 O(2^n)에서 O(n)으로 줄었다.

<Picture src="dynamic-programing_2.png" alt="다이나믹 프로그래밍 - 재귀 트리" />
